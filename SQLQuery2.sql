CREATE Database TimKiemViecLam
GO
USE TimKiemViecLam
...
ALTER TABLE CONG_VIEC ALTER COLUMN MoTaCV NVARCHAR(1000);
ALTER TABLE dbo.CONG_VIEC ALTER COLUMN YeuCauCV NVARCHAR(1000);
...
SELECT CONG_VIEC.IdUser, CONG_VIEC.TieuDe, CONG_VIEC.SoLuongTuyen, CONG_VIEC.GioiTinhTuyen, CONG_VIEC.MoTaCV, CONG_VIEC.YeuCauCV, CONG_VIEC.HinhThuc,
CONG_VIEC.KinhNghiemTuyen, CONG_VIEC.TGThuViec, CONG_VIEC.QuyenLoi, CONG_VIEC.NganhNghe, CONG_VIEC.LuongCoBan, CONG_VIEC.NgayHetHan, CONG_VIEC.TenCongTy,
CONG_VIEC.IdDC,SDT, CONG_VIEC.QuyMoNhanSu, CONG_VIEC.LinhVucHoatDong, CONG_VIEC.SoLuocCT, CONG_VIEC.TrangThai, CONG_VIEC.TrinhDo 
...
select HS.Id,HS.Fullname,TK.Sdt,HS.NgaySinh,HS.GioiTinh,DC.Tinh from HO_SO as HS LEFT JOIN TAI_KHOAN TK ON HS.Id = TK.Id LEFT JOIN DIA_CHI DC ON HS.IdDC = DC.Id WHERE HS.MucLuongMongMuon BETWEEN 10000 AND 20000
select * from HO_SO